      ...
      if (type === pokemonTypeOne) {
        ...
        doubleDamageFrom.forEach((type) => {
          ...
          if (name === pokemonTypeTwo) {
            ...
            console.log("scoreDD:" + scoreDamageFrom);
          } else return;
        });
        console.log({ scoreDamageFrom });
        console.log(typeMapping[type].double_damage_from);
        const halfDamageFrom = typeMapping[type].half_damage_from;
        halfDamageFrom.forEach((type) => {
          const { name } = type;
          console.log("name hald:" + name);
          if (name === pokemonTypeTwo) {
            scoreDamageFrom = scoreDamageFrom - 0.5;
            console.log("scoreHalfD" + scoreDamageFrom);
          } else return;
        });
